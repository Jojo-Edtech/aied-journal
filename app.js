...
const I18N = {
  zh: {
    ...
    topicLenses: "主题镜头",
    signalsTitle: "期刊信号",
    signalsCopy: "JCR 指标、研究主题、编辑团队与最新卷期动态。",
    controlEyebrow: "期刊情报",
    colDecision: "一审时长",
    heroEyebrow: "研究工作台",
    ...
    publisherCopy: "按出版社集团汇总当前筛选期刊数量。",
    ...
    themeMapTitle: "主题地图",
    themeMapCopy: "按宽泛 / 具体 / 细分三个层级显示主题偏好柱状图；点击条形查看支撑文章。",
    timeSlice: "时间范围",
    recent3Issues: "近3期",
    last1Year: "近1年",
    last2Years: "近2年",
  ...
  en: {
    ...
    brandTagline: "Research Radar",
    topicLenses: "Topic lenses",
    signalsTitle: "Journal signals",
    signalsCopy: "JCR metrics, topics, editors, latest issue signals.",
...
function renderChatResponse(data) {
  ...
  const metaItems = [
    data.retrieval_scope === "full_journal_database"
      ? t("fullLibraryScope", { count: data.searched_journal_count ?? state.journals.length })
      : "",
...
async function updateChatStatus() {
  ...
  try {
    ...
    els.chatStatus.textContent = t("chatConnected", {
      ...
      journals: health.journal_count ?? health.documents ?? state.journals.length,
    });
